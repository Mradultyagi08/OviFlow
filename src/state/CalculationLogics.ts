...
import { CyclePhase } from "../data/DailyTips";
...
/**
 * Returns the current cycle phase as a simple string tag
 * used by DailyTips to pick the right message.
 */
