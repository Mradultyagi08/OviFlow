...
router.put("/preferences", auth, async (req, res) => {
  try {
    const allowed = ["theme", "accentColor", "waterGoal", "temperatureUnit", "defaultSymptoms", "aiInsightsEnabled", "lutealPhaseLength", "ovulationReminder", "appLockEnabled", "appLockPin", "doctorNumber", "doctorMessage", "fallingFlowers"];
    const updates = {};
